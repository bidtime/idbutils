...
public class SqlLoadUtils {
	...
	private String getSqlOfId(Class clazz, String id, String colId) throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public int delete(DataSource ds, Class clazz, Object[] params)
			throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public int delete(DataSource ds, Class clazz, String fld, Object[] params)
			throws SQLException {
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings("rawtypes")
	public int delete(DataSource ds, Class clazz, String[] flds, Object[] params)
			throws SQLException {
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	public int delete(DataSource ds, String tblName, String[] flds, Object[] params)
			throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public int delete(DataSource ds, Class clazz, GsonRow o) throws SQLException {
		if (o == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings("rawtypes")
	public int delete(DataSource ds, Class clazz,
	...
	private int delete(DataSource ds, String tblName,
			GsonRow o, String[] heads) throws SQLException {
		if (o == null) {
			return 0;
		}
	...
	public int delete(DataSource ds, Class clazz, Object object) throws SQLException {
		if (object == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int delete(DataSource ds, Class clazz, Object object, String[] heads) throws SQLException {
		if (object == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
    ...
    private boolean isJavaSimpleClazz(Class<?> type) {
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int delete(DataSource ds, Class clazz, List list) throws SQLException {
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int delete(DataSource ds, Class clazz, List list, String[] heads) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		Object o = list.get(0);
	...
	@SuppressWarnings("rawtypes")
	public int insert(DataSource ds, Class clazz,
	...
	@SuppressWarnings({ "rawtypes"})
	public int insert(DataSource ds, Class clazz, Object object) throws SQLException {
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int insert(DataSource ds, Class clazz, Object object, PropAdapt pa) throws SQLException {
		if (object == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes" })
	public int insert(DataSource ds, Class clazz, List list) throws SQLException {
		return insert(ds, clazz, list, PropAdapt.NOTNULL);
	}
	
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int insert(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes"})
	public int insertIgnore(DataSource ds, Class clazz, Object object) throws SQLException {
		return insertIgnore(ds, clazz, object, PropAdapt.NOTNULL);
	}

	@SuppressWarnings({ "rawtypes" })
	public int insertIgnore(DataSource ds, Class clazz, List list) throws SQLException {
		return insertIgnore(ds, clazz, list, PropAdapt.NOTNULL);
	}

	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int insertIgnore(DataSource ds, Class clazz, Object object, PropAdapt pa) throws SQLException {
		if (object == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int insertIgnore(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes"})
	public int replace(DataSource ds, Class clazz, Object object) throws SQLException {
		return replace(ds, clazz, object, PropAdapt.NOTNULL);
	}

	@SuppressWarnings({ "rawtypes" })
	public int replace(DataSource ds, Class clazz, List list) throws SQLException {
		return replace(ds, clazz, list, PropAdapt.NOTNULL);
	}

	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int replace(DataSource ds, Class clazz, Object object, PropAdapt pa) throws SQLException {
		if (object == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
		...
		try {
			...
			return DbConnection.update(ds, tp, g, 
	            ...
	            @Override  
	            public String getSql(TTableProps tp, GsonRow g, Connection c) throws SQLException {
	            	String insSql = CAutoFitSql.getReplace(c);
		        	return tp.getInsertSql(g, true, insSql);
		        }  
			});
		} finally {
	...
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int replace(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes" })
	public int insertIgnoreBatch(DataSource ds, Class clazz, List list) throws SQLException {
		return insertIgnoreBatch(ds, clazz, list, PropAdapt.NOTNULL);
	}
  
  @SuppressWarnings({ "rawtypes", "unchecked"})
  public int insertIgnoreBatch(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
    if (list == null || list.isEmpty()) {
      return 0;
    }
    TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
  ...
  public int insertIgnoreBatch(DataSource ds, GsonRows g, String tblName) throws SQLException {
    ...
    int n = DbConnection.updateBatch(ds, null, g, 
        new SQLCallback<TTableProps, GsonRows, Connection>(){
            ...
            public String getSql(TTableProps tp, GsonRows g, Connection c) throws SQLException {
              String insSql = CAutoFitSql.getInsertIgnore(c);                
              return SqlUtils.getInsertSql(tblName, g.getHead(), insSql);
          }  
    });
    return n;
  }
  
  public int repalceIgnoreBatch(DataSource ds, GsonRows g, String tblName) throws SQLException {
    if (g == null || !g.isExistsData()) {
      return 0;
    }
    int n = DbConnection.updateBatch(ds, null, g, 
  ...
  public int insertIgnoreBatch(DataSource ds, List list, String tblName) throws SQLException {
    if (list == null || list.isEmpty()) {
      return 0;
    }
    TTableProps tp = null;
    ...
    try {
      if (list.get(0) instanceof Map) {
        ...
        g = tp.clazzToRows(list, true, PropAdapt.NOTNULL);
      }
      n += DbConnection.updateBatch(ds, tp, g, 
          new SQLCallback<TTableProps, GsonRows, Connection>(){
              @Override  
	...
	@SuppressWarnings({ "rawtypes" })
	public int insertBatch(DataSource ds, Class clazz, List list) throws SQLException {
		return insertBatch(ds, clazz, list, PropAdapt.NOTNULL);
	}
	
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int insertBatch(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes" })
	public int updateBatch(DataSource ds, Class clazz, List list) throws SQLException {
		return updateBatch(ds, clazz, list, PropAdapt.NOTNULL);
	}
	
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public int updateBatch(DataSource ds, Class clazz, List list, PropAdapt pa) throws SQLException {
		if (list == null || list.isEmpty()) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	//insertForPK
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public int insertForPK(DataSource ds, Class clazz,
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public <T> T insertForPK(DataSource ds, Class clazz,
			GsonRow g) throws SQLException {
		if (g == null) {
			return null;
		}
...
//	}
	...
	// update
	@SuppressWarnings("rawtypes")
	public int update(DataSource ds, Class clazz,
			GsonRows g) throws SQLException {
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings({ "rawtypes" })
	public int update(DataSource ds, Class clazz, Object o) throws SQLException {
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private int update(DataSource ds, TTableProps tp,
			Object o, String[] heads, PropAdapt pa) throws SQLException {
		if (o == null) {
			return 0;
		}
	...
	@SuppressWarnings("rawtypes")
	public int update(DataSource ds, Class clazz, GsonRow g) throws SQLException {
		if (g == null) {
			return 0;
		}
		TTableProps tp = JsonFieldXmlsLoader.getTableProps(clazz);
	...
	@SuppressWarnings("rawtypes")
	public int update(DataSource ds, Class clazz, String sqlId,
	...
	//updateBatch
	@SuppressWarnings("rawtypes")
	public int updateBatch(DataSource ds, Class clazz, String sqlId,
			Object[][] params) throws SQLException {
		String sql = getSqlOfId(clazz, sqlId, null);
		return DbConnection.updateBatch(ds, sql, params);
	}

	public int updateSqlBatch(DataSource ds, String sql,
			Object[][] params) throws SQLException {
		return DbConnection.updateBatch(ds, sql, params);
	}
	...
	//update sql
	public int updateSql(DataSource ds, String sql, Object[] params) throws SQLException {
		return DbConnection.update(ds, sql, params);
	}

	public int updateSql(DataSource ds, String sql) throws SQLException {
		return DbConnection.update(ds, sql, (Object[])null);
	}
	
	//call sp
	@SuppressWarnings("rawtypes")
	public boolean callSP(DataSource ds, Class clazz, String sqlId,
	...
	@SuppressWarnings("rawtypes")
	public boolean callSpIn(DataSource ds, Class clazz, String sqlId,
	...
	@SuppressWarnings("rawtypes")
	public boolean callSpOut(DataSource ds, Class clazz,
	...
	public <T> T querySql(DataSource ds, String sql, ResultSetHandler<T> rsh,
			Map<String, ?> params) throws SQLException {
	...
	public <T> T querySqlOne(DataSource ds, String sql, ResultSetHandler<T> rsh,
			Map<String, ?> params) throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public <T> T query(DataSource ds, Class clazz, String sqlId, String colId,
	...
	@SuppressWarnings("rawtypes")
	public <T> T queryOne(DataSource ds, Class clazz, String sqlId, String colId,
			ResultSetHandler<T> rsh, Map<String, ?> params) throws SQLException {
		return query(ds, clazz, sqlId, colId, params, 0, 1, rsh);
	}
	
	@SuppressWarnings("rawtypes")
	public <T> T query(DataSource ds, Class clazz, String sqlId, 
			Map<String, ?> params, Integer pageIdx, Integer pageSize, 
			ResultSetHandler<T> rsh) throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public <T> T query(DataSource ds, Class clazz, String sqlId, ResultSetHandler<T> rsh,
			Map<String, ?> params) throws SQLException {
		return query(ds, clazz, sqlId, params, null, null, rsh);
	}

	@SuppressWarnings("rawtypes")
	public <T> T queryOne(DataSource ds, Class clazz, String sqlId, ResultSetHandler<T> rsh,
			Map<String, ?> params) throws SQLException {
		return query(ds, clazz, sqlId, params, 0, 1, rsh);
	}
	
	@SuppressWarnings("rawtypes")
	private boolean isJavaSimpleClazz(Object o) throws SQLException {
		boolean result = false;
		if (o instanceof Map) {
			result = false;
	...
	@SuppressWarnings({ "rawtypes" })
	public <T> T queryByPK(DataSource ds, Class clazz, String sqlId, String colId,
...
//				}
	...
	@SuppressWarnings("rawtypes")
	public <T> T queryByPK(DataSource ds, Class clazz, String sqlId, String colId, ResultSetHandler<T> rsh,
			Object o) throws SQLException {
		return queryByPK(ds, clazz, sqlId, colId, o, null, null, rsh);
	}

	@SuppressWarnings("rawtypes")
	public <T> T queryByPKOne(DataSource ds, Class clazz, String sqlId, String colId, ResultSetHandler<T> rsh,
			Object o) throws SQLException {
		return queryByPK(ds, clazz, sqlId, colId, o, 0, 1, rsh);
	}
	
	@SuppressWarnings({ "rawtypes" })
	public <T> T queryByPK(DataSource ds, Class clazz, String sqlId,
			Object o, Integer pageIdx, Integer pageSize,
			ResultSetHandler<T> rsh) throws SQLException {
	...
	@SuppressWarnings("rawtypes")
	public <T> T queryByPK(DataSource ds, Class clazz, String sqlId, ResultSetHandler<T> rsh,
			Object o) throws SQLException {
		return queryByPK(ds, clazz, sqlId, o, null, null, rsh);
	}

	@SuppressWarnings("rawtypes")
	public <T> T queryByPKOne(DataSource ds, Class clazz, String sqlId, ResultSetHandler<T> rsh,
			Object o) throws SQLException {
