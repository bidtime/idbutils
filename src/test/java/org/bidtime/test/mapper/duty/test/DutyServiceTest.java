 ...
 */
public class DutyServiceTest extends BasicTest {

	//@Autowired
	//protected DutyMapper service;

	@Test
	public void test_selectOfAll() throws SQLException {
		//BeanHandler<Duty> h = new BeanHandler<Duty>(Duty.class);
//		BeanListHandler<Duty> h = new BeanListHandler<Duty>(Duty.class);
//		Map<String, Object> params = new HashMap<>();
//		DutyMapper service = MethodProxyFactory.newInstance(DutyMapper.class);
//		Object dto = service.selectSqlOfAll(h, params);
