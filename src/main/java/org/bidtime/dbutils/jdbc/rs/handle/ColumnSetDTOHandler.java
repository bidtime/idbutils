...
public class ColumnSetDTOHandler<T> extends AbstractSetDTOHandler<T> {
    ...
    public ColumnSetDTOHandler(SetCallback<T> ccb) {
        this(1, null);
    	this.ccb = ccb;
    }

    public ColumnSetDTOHandler() {
        this(1, null);
    }
     ...
     * <code>ResultSet</code>.
     */
    public ColumnSetDTOHandler(int columnIndex) {
     ...
     * <code>ResultSet</code>.
     */
    public ColumnSetDTOHandler(String columnName) {
        this(1, columnName);
    }
     ...
     * <code>ResultSet</code>.
     */
    private ColumnSetDTOHandler(int columnIndex, String columnName) {
        super();
