 ...
 * @since DbUtils 1.1
 */
public class ColumnSetHandler<T> extends AbstractSetHandler<T> {
     ...
     */
    public ColumnSetHandler(SetCallback<T> ccb) {
        this(1, null);
    	this.ccb = ccb;
    }

    public ColumnSetHandler() {
        this(1, null);
    }
     ...
     * <code>ResultSet</code>.
     */
    public ColumnSetHandler(int columnIndex) {
     ...
     * <code>ResultSet</code>.
     */
    public ColumnSetHandler(String columnName) {
        this(1, columnName);
    }
     ...
     * <code>ResultSet</code>.
     */
    private ColumnSetHandler(int columnIndex, String columnName) {
        super();
