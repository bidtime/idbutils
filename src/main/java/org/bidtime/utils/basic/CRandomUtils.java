...
public class CRandomUtils {
	...
	//private static String S_DICTION_REMOVE_ZERO = "abcdefghijklmnpqrstuvwxyz123456789";
	private static char[] DICTION_REMOVE_ZERO = "abcdefghijklmnpqrstuvwxyz123456789".toCharArray();
